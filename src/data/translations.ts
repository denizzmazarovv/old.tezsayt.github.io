export const translations = {
  ru: {
    ...
    hero: {
      title: "Сайты, работающие для вас 24/7",
      subtitle: "Профессиональные сайты с упором на скорость и безопасность",
      cta: "Начать проект",
    ...
    about: {
      ...
      description:
        "Мы специализируемся на создании современных и функциональных веб-решений. Наша команда профессионалов поможет воплотить ваши идеи в жизнь.",
    ...
    services: {
      ...
      landing: {
        ...
        description:
          "Создаем эффективные одностраничные сайты для продвижения ваших товаров и услуг",
      },
      website: {
  ...
  en: {
    ...
    hero: {
      title: "Websites that work 24/7",
      subtitle: "Professional websites built for speed and security",
      cta: "Start Project",
      contact: "Contact Us",
    },
    about: {
      ...
      description:
        "We specialize in creating modern and functional web solutions. Our team of professionals will help bring your ideas to life.",
    ...
    services: {
      ...
      landing: {
        title: "Landing Pages",
        description:
          "We create effective single-page websites to promote your products and services",
      },
      website: {
  ...
  uz: {
    ...
    hero: {
      title: "24/7 ishlaydigan veb-saytlar",
      subtitle:
        "Tezlik va xavfsizlikka eʼtibor qaratilgan professional saytlar",
    ...
    about: {
      ...
      description:
        "Biz zamonaviy va funksional veb yechimlarni yaratishga ixtisoslashganmiz. Bizning mutaxassislar jamoamiz sizning g‘oyalaringizni hayotga tatbiq etishga yordam beradi.",
    ...
    services: {
      ...
      landing: {
        ...
        description:
          "Mahsulot va xizmatlaringizni targ'ib qilish uchun samarali bir sahifali veb-saytlar yaratamiz",
      },
      website: {
    ...
    contact: {
      ...
      subtitle:
        "Loyihangizni muhokama qilishga tayyormisiz? Biz doimo aloqadamiz!",
      phone: "Telefon",
      email: "Email",
      address: "Manzil",
    },
